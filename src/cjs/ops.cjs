...
(function (OPS) {
  ...
  OPS[(OPS['OP_REQUIRE_COINSTAKE'] = 185)] = 'OP_REQUIRE_COINSTAKE';
  OPS[(OPS['OP_CHECKSIGADD'] = 186)] = 'OP_CHECKSIGADD';
  // DIVI-specific opcodes
  OPS[(OPS['OP_CHECKCOLDSTAKEVERIFY_LOF'] = 209)] = 'OP_CHECKCOLDSTAKEVERIFY_LOF';
  OPS[(OPS['OP_CHECKCOLDSTAKEVERIFY'] = 210)] = 'OP_CHECKCOLDSTAKEVERIFY';
  OPS[(OPS['OP_EXCHANGEADDR'] = 224)] = 'OP_EXCHANGEADDR';
